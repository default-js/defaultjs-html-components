...
/* harmony import */ var _Route__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Route */ "./src/Application/Route/index.js");
/* harmony import */ var _RouteLink__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RouteLink */ "./src/Application/RouteLink/index.js");
/* harmony import */ var _View__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./View */ "./src/Application/View/index.js");
...
const findRoute = (app, name) => {
    const selector = `${_Route__WEBPACK_IMPORTED_MODULE_4__["default"].NODENAME}[name="${name}"]`;
...
class AppComponent extends _Component__WEBPACK_IMPORTED_MODULE_0__["default"] {
	...
	async routes() {
		return this.root.find(_Route__WEBPACK_IMPORTED_MODULE_4__["default"].NODENAME);
    }
    ...
    async route(route){
        ...
        else if(route instanceof _RouteLink__WEBPACK_IMPORTED_MODULE_5__["default"])
	...
	get view() {
		if (!this.__view__){
			this.__view__ = Object(_utils_NodeHelper__WEBPACK_IMPORTED_MODULE_1__["findClosestInDepth"])(this.root, (node) => {
				return node instanceof _View__WEBPACK_IMPORTED_MODULE_6__["default"];
			});
...
/* harmony import */ var _Nodename__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Nodename */ "./src/Application/Route/Nodename.js");
/* harmony import */ var _Events__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Events */ "./src/Application/Route/Events.js");
/* harmony import */ var _Attributes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Attributes */ "./src/Application/Route/Attributes.js");
...
const ATTRIBUTES = [_Attributes__WEBPACK_IMPORTED_MODULE_7__["ATTR_NAME"], _TemplateHelper__WEBPACK_IMPORTED_MODULE_2__["ATTR_TEMPLATE"], _Attributes__WEBPACK_IMPORTED_MODULE_7__["ATTR_COMPONENT_TAG"], _Attributes__WEBPACK_IMPORTED_MODULE_7__["ATTR_COMPONENT_TAG_ATTRIBUTES"], _Attributes__WEBPACK_IMPORTED_MODULE_7__["ATTR_STATEFUL"]];
...
const getTagAttributes = async (route) => {
	...
	return _default_js_defaultjs_expression_language_src_ExpressionResolver__WEBPACK_IMPORTED_MODULE_4__["default"].resolve(attributes, {}, {});
};
...
class Route extends _Component__WEBPACK_IMPORTED_MODULE_0__["default"] {
	...
	set active(active) {
		...
		if (active != current) {
			...
			if (active) {
				...
				if (!this.hasAttribute(_Attributes__WEBPACK_IMPORTED_MODULE_7__["ATTR_STATEFUL"])) delete this.__component__;
			}
		}
	}
	...
	async render({ view, data, app }) {
		if (!this.__component__) {
			...
			if (this.__component__ instanceof _default_js_defaultjs_template_language__WEBPACK_IMPORTED_MODULE_3__["Template"]) {
				await _default_js_defaultjs_template_language__WEBPACK_IMPORTED_MODULE_3__["Renderer"].render({ container: view, data, template: this.__component__ });
...
/*!********************************************!*\
  !*** ./src/Application/RouteLink/index.js ***!
  \********************************************/
/*! exports provided: ATTR_TARGET, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
