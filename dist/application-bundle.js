...
/*!*********************************************!*\
  !*** ./src/Application/Route/Attributes.js ***!
  \*********************************************/
/*! exports provided: ATTR_NAME, ATTR_ACTIVE, ATTR_TEMPLATE, ATTR_COMPONENT_TAG, ATTR_COMPONENT_TAG_ATTRIBUTES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _default_js_defaultjs_expression_language_src_ExpressionResolver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @default-js/defaultjs-expression-language/src/ExpressionResolver */ "./node_modules/@default-js/defaultjs-expression-language/src/ExpressionResolver.js");
/* harmony import */ var _Nodename__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Nodename */ "./src/Application/Route/Nodename.js");
/* harmony import */ var _Events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Events */ "./src/Application/Route/Events.js");
/* harmony import */ var _Attributes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Attributes */ "./src/Application/Route/Attributes.js");
...
const ATTRIBUTES = [_Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_NAME"], _Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_TEMPLATE"], _Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_COMPONENT_TAG"], _Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_COMPONENT_TAG_ATTRIBUTES"]];
const EVENTS = [_Events__WEBPACK_IMPORTED_MODULE_4__["EVENT_CLICK"], _Events__WEBPACK_IMPORTED_MODULE_4__["EVENT_ACTIVATE"], _Events__WEBPACK_IMPORTED_MODULE_4__["EVENT_DEACTIVATE"]];
const getTagAttributes = async (route) => {	
	const attributes = route.attr(_Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_COMPONENT_TAG_ATTRIBUTES"]) || "{}";
	return _default_js_defaultjs_expression_language_src_ExpressionResolver__WEBPACK_IMPORTED_MODULE_2__["default"].resolve(attributes, {}, {});
}

const buildComponent = async (route) =>{
	const tag = route.attr(_Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_COMPONENT_TAG"]);
...
class Route extends _Component__WEBPACK_IMPORTED_MODULE_0__["default"] {
	...
	static get NODENAME() { return _Nodename__WEBPACK_IMPORTED_MODULE_3__["default"]; }
	...
	constructor() {
		super();
		this.on("click", () => {
			this.trigger(_Events__WEBPACK_IMPORTED_MODULE_4__["EVENT_CLICK"]);
		});
	}	
	...
	get name() {
		return this.attr(_Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_NAME"]);
	}

	get active() {
		return this.hasAttribute(_Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_ACTIVE"]);
	}

	set active(active) {
		const current = this.active;
		if (active != current) {
			this.attr(_Attributes__WEBPACK_IMPORTED_MODULE_5__["ATTR_ACTIVE"], active ? "" : null);
			if (active) {
				this.trigger(_Events__WEBPACK_IMPORTED_MODULE_4__["EVENT_ACTIVATE"]);
			} else {
				this.trigger(_Events__WEBPACK_IMPORTED_MODULE_4__["EVENT_DEACTIVATE"]);
