...
class Pagination extends _Component__WEBPACK_IMPORTED_MODULE_3__["default"] {
	...
	async init() {
		...
		const template = await _default_js_defaultjs_template_language__WEBPACK_IMPORTED_MODULE_2__["Template"].load(templateElement, templateElement instanceof URL);
		this.__root__ = this;
