...
class Pagination extends _Component__WEBPACK_IMPORTED_MODULE_3__["default"] {
	...
	async init() {
		const template = await _default_js_defaultjs_template_language__WEBPACK_IMPORTED_MODULE_2__["Template"].load(getTemplate(this));
		let root = this;
...
/* harmony default export */ __webpack_exports__["default"] = ({ Pagination: _Pagination__WEBPACK_IMPORTED_MODULE_0__["default"] });
