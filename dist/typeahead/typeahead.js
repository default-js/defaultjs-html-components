...
const NODENAME = Object(_utils_DefineComponentHelper__WEBPACK_IMPORTED_MODULE_1__["toNodeName"])("typeahead");
const ATTRIBUTES = [_utils_TemplateHelper__WEBPACK_IMPORTED_MODULE_4__["ATTR_TEMPLATE"]];
...
class Typeahead extends _Component__WEBPACK_IMPORTED_MODULE_5__["default"] {
	...
	async init() {
		...
		if (!this.ready.resolved) {
			const template = await Object(_utils_TemplateHelper__WEBPACK_IMPORTED_MODULE_4__["loadTemplate"])(this, TEMPLATE);
...
Object(_utils_DefineComponentHelper__WEBPACK_IMPORTED_MODULE_1__["define"])(Typeahead);
